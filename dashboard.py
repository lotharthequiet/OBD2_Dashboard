...
def main():
    print(f"Starting {APP_TITLE} {__version__} {__status__}...")
    ...
    # Define a function to draw a gauge needle
    ...
    # Define a function to draw the shift indicator
    ...
    # Define a function to draw the separator image
    ...
    # Define a function to draw the info center
    ...
    # Define a function to draw the tachometer labels
    ...
    # Define a function to draw the speedometer labels
    ...
    # Define a function to draw the fuel gauge labels
    ...
    # Define a function to draw the Sensors screen
    def draw_sensors_screen(engine_temperature, speed, rpm, fuel_level):
        screen.fill(BLACK)

    # Define a function to draw the Diagnostics Screen
